...
def valid_patterns_for_section(credits, skel_days, skel_duration, max_candidates=10):
    """
...
def _build_section_entry(i, crn, course, title, instructor, days, duration_mins,
                          ...
                          db_section_id=None, max_candidates=10):
    cr = credits or 3
...
def load_data_from_csv(csv_path, max_candidates=10):
...
def load_data_from_db(db_path, semester, course_scope="core", max_candidates=10):
...
def load_data(*, source="csv", csv_path=None, db_path=None,
              semester="202602", course_scope="core", max_candidates=10):
